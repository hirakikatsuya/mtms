...
ActiveRecord::Schema.define(version: 2022_12_02_044339) do
  ...
  create_table "training_tags", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["tag_id"], name: "index_training_tags_on_tag_id"
    t.index ["training_id"], name: "index_training_tags_on_training_id"
  end
  ...
  add_foreign_key "training_tags", "tags"
  add_foreign_key "training_tags", "trainings"
